...
/*   Updated: 2025/09/21 12:02:18 by mhdeeb           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	down(t_minilibx *data, int old_x, int old_y)
{
	...
	if (old_x == data->map.exit_pose.x && old_y == data->map.exit_pose.y)
		draw_image_32(data, "srcs/images/others/E.xpm", old_x * 32, old_y * 32);
	else
